...
export default function BookingHero() {
  return (
    <section
      ...
      style={{
        background: 'radial-gradient(circle at center, rgba(240, 244, 239, 0.45) 0%, rgba(255, 255, 255, 0.6) 100%)'
      }}
    >
      ...
      <div className="relative z-10 text-center px-4">
        <span className="font-label text-[10px] uppercase tracking-[0.4em] text-[var(--lords-gold)] block mb-2 font-medium">
          RESERVATIONS
        </span>
        ...
        <div className="flex flex-wrap justify-center items-center gap-6 md:gap-8 mt-6">
          <span className="font-label text-[10px] md:text-xs text-[var(--lords-cream)]/95 flex items-center gap-2 tracking-wider">
            <CheckCircle size={13} className="text-[var(--lords-gold)]" /> Best Rate Guaranteed
          </span>
          <span className="font-label text-[10px] md:text-xs text-[var(--lords-cream)]/95 flex items-center gap-2 tracking-wider">
            <CheckCircle size={13} className="text-[var(--lords-gold)]" /> Free Cancellation
          </span>
          <span className="font-label text-[10px] md:text-xs text-[var(--lords-cream)]/95 flex items-center gap-2 tracking-wider">
            <CheckCircle size={13} className="text-[var(--lords-gold)]" /> 24hr Quick Confirm
          </span>
        </div>
      </div>
    </section>
