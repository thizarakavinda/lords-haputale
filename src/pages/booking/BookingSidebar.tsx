...
export default function BookingSidebar({
  ...
  return (
    <div
      className="w-full lg:sticky lg:top-[100px] overflow-hidden"
      style={{
    ...
    >
      ...
      <div className="w-full h-[180px] relative overflow-hidden group border-b border-[var(--lords-stone)]/30">
        ...
        />
        <span className="absolute bottom-4 left-6 z-20 font-label text-[10px] uppercase tracking-widest text-white bg-black/40 px-3 py-1.5 rounded-sm backdrop-blur-sm border border-white/10">
          {selectedRoom.name}
        </span>
      </div>
      ...
      <div className="p-7 md:p-8 flex flex-col">
        ...
        <span className="font-label text-[9px] uppercase tracking-[0.4em] text-[var(--lords-muted)] mb-3 block">
          YOUR BOOKING
        </span>
        ...
        <div className="flex flex-col gap-3.5 border-b border-[var(--lords-stone)]/40 pb-5 mb-5 font-body text-xs">
          ...
          <div className="flex justify-between items-center">
            <span className="text-[var(--lords-muted)]">Dates</span>
            <span className="text-[var(--lords-cream)] text-right">
          ...
          {/* Nights count */}
          <div className="flex justify-between items-center">
            <span className="text-[var(--lords-muted)]">Nights</span>
            <span className="text-[var(--lords-cream)]">
          ...
          {/* Room Type */}
          <div className="flex justify-between items-center">
            <span className="text-[var(--lords-muted)]">Selected Room</span>
            <span className="text-[var(--lords-cream)]">{selectedRoom.name}</span>
          </div>

          {/* Guest Breakdown */}
          <div className="flex justify-between items-center">
            <span className="text-[var(--lords-muted)]">Guests</span>
            <span className="text-[var(--lords-cream)]">
        ...
        <div className="border-b border-[var(--lords-stone)]/40 pb-5 mb-5">
          <span className="font-label text-[9px] uppercase tracking-[0.2em] text-[var(--lords-muted)] block mb-1">
            ESTIMATED TOTAL
          </span>

          <div className="flex items-baseline gap-1.5 mt-0.5">
            <span className="font-display text-[44px] text-[var(--lords-gold)] font-normal leading-none">
              {pricing.isValid ? `$${pricing.total.toFixed(2)}` : '$—'}
            </span>
          </div>

          <span className="font-body text-[10px] text-[var(--lords-muted)]/80 block mt-1">
        ...
        <div className="flex flex-col">
          <span className="font-label text-[9px] uppercase tracking-[0.2em] text-[var(--lords-muted)] block mb-3.5">
            NEED HELP?
          </span>
          ...
          <div className="flex flex-col gap-2.5 mt-4 font-body text-[11px] text-[var(--lords-muted)]">
