...
export default function HomeCTA() {
  return (
    <section className="relative w-full h-[60vh] min-h-[500px] bg-[var(--lords-forest)] flex items-center justify-center pt-12 pb-24 z-0">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6">
        ...
        <Link 
          to="/booking"
          className="bg-[var(--lords-gold)] text-[var(--lords-charcoal)] font-label text-[13px] uppercase tracking-wider px-12 py-[18px] hover:bg-[var(--lords-gold-light)] transition-colors duration-300 rounded-sm mb-6"
        >
          Book Your Stay
        </Link>
